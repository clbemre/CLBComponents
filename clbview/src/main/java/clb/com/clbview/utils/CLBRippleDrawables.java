...
// TODO LATER
public class CLBRippleDrawables {

    @NonNull
    public static Drawable getSelectableDrawableFor(int color, int rippColor, int cornerRadius) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            Drawable rippleColor = getRippleColor(rippColor, cornerRadius);
